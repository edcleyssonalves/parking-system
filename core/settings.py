...
SECRET_KEY = 'django-insecure-n$_!sj^0a8o9lipuhelrkqku7gq#fp0)ow&da()f(sth#l_$a4'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['.assinaai.online']
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Parking Service",

    # Copyright on the footer
    "copyright": "X-LABS SEC Ltda",
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Service Parking API',
    'DESCRIPTION': 'API Project for Parking Services',
    'VERSION': '1.0.0',
}
